...
@php
    $pageTitle = 'Edit Kelompok Program';
@endphp
...
<div class="mx-auto max-w-4xl space-y-6">
    <section class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
            ...
            <h2 class="mt-2 text-3xl font-extrabold tracking-tight text-slate-900">Edit Kelompok Program</h2>
            <p class="mt-2 max-w-2xl text-sm leading-6 text-slate-600">Perbarui kelompok {{ $category->name }}.</p>
        </div>
