...
<div class="mx-auto max-w-5xl">
    <div class="mb-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
            ...
            <h2 class="mt-2 text-3xl font-extrabold tracking-tight text-slate-900">Tambah Soal</h2>
        </div>
    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <form method="POST" action="{{ route('admin.placement.questions.store') }}">
            @include('admin.placement.questions._form', ['question' => null])
        </form>
    </section>
</div>
@endsection
