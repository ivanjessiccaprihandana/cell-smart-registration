...
@section('content')
    <!-- Hero Section -->
    <section class="mx-auto max-w-7xl px-6 py-20 md:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="flex gap-4 pt-4">
                    <button class="inline-flex items-center justify-center rounded-lg px-8 py-3 text-sm font-semibold text-white shadow-lg bg-primary hover:bg-primary-hover transition-all active:scale-95">Daftar Sekarang</button>
    ...
    <!-- Statistics Section -->
    <section class="bg-gradient-to-r from-slate-50 to-slate-100 py-16 md:py-20">
    ...
    <!-- CTA Section -->
    <section class="mx-auto max-w-7xl px-6 py-16 md:px-8 text-center">
        <div class="bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-2xl p-12 md:p-16">
            ...
            <button class="inline-flex items-center justify-center rounded-xl px-8 py-4 text-base font-semibold text-white shadow-xl bg-primary hover:bg-primary-hover transition duration-200 ease-out active:scale-95">
